...
const __FlashStringHelper *button_names[] = {
  (const __FlashStringHelper *)"Up", (const __FlashStringHelper *)"Down", (const __FlashStringHelper *)"Enter", (const __FlashStringHelper *)"Cancel"
};
...
const __FlashStringHelper *bt_button_names[] = {
  (const __FlashStringHelper *)("BT_POWER"), (const __FlashStringHelper *)("BT_FWD"), (const __FlashStringHelper *)("BT_BACK"), (const __FlashStringHelper *)("BT_VOLUP"), (const __FlashStringHelper *)("BT_VOLDN"), (const __FlashStringHelper *)("BT_PLAY")
};
...
void Expander::readButtons()
{
  ...
  for (int a=0;a<BUTTON_LAST;a++) {
      ...
      if (current_state==LOW) {
        //Serial.print(F2("Panel Button: "));
        
        Serial.println((const char*)button_names[a]);
...
void Expander::bluetoothPress(BT_BUTTON btn)
{
    ...
    Serial.print((const char*)F2("BT_BUTTON: "));  
    //Serial.print(bt_button_names[(int)btn]);
    Serial.print(btn);
    Serial.print((const char*)F2(" | Expander PIN: "));
