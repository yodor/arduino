...
#define EN_PIN    ORIG_Y_ENABLE_PIN //enable (CFG6)
#define DIR_PIN   ORIG_Y_DIR_PIN //direction
#define STEP_PIN  ORIG_Y_STEP_PIN //step

#define CS_PIN   ORIG_Y_CS_PIN //chip select
